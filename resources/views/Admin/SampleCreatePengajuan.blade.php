...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <h5 class="fw-bold fs-10"><i class="fa-solid fa-book px-1"></i>Ajukan Permohonan Bantuan</h5>
        </div>
        <div class="card-body">
            <form id="submissionForm">
                ...
                <div class="d-flex justify-content-end">
                    <button type="button" id="cencelData" class="btn btn-danger mt-3">Batal</button>
                    <button type="button" id="saveData" class="btn btn-primary mt-3">Ajukan Permohonan</button>
                </div>
            </form>
        </div>
    </div>
